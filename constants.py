...
RANKED_LIST_SYS_PROMPT = 'You are a marketing assistant tasked with identifying top brands. Do not confuse brands with products. Return a JSON object where the keys are the brand names and the values are the order you return them. Example output: {"foo": 1, "bar": 2}'
